    ...
    def generator(self, z, y=None):
        if not self.y_dim:
            ...
            h0_1 = tf.nn.relu(conv2d(h0, output_dim=128,
                       k_h=3, k_w=3, d_h=1, d_w=1, stddev=0.02, name="g_conv2d_1_1"))
            h0_2 = tf.nn.relu(conv2d(h0_1, output_dim=128,
                       k_h=3, k_w=3, d_h=1, d_w=1, stddev=0.02, name="g_conv2d_1_2"))
            h0_3 = tf.nn.relu(conv2d(h0_2, output_dim=128,
                       k_h=3, k_w=3, d_h=1, d_w=1, stddev=0.02, name="g_conv2d_1_3"))
            ...
            h1_1 = tf.nn.relu(conv2d(h1, output_dim=128,
                       k_h=3, k_w=3, d_h=1, d_w=1, stddev=0.02, name="g_conv2d_2_1"))
            h1_2 = tf.nn.relu(conv2d(h1_1, output_dim=128,
                       k_h=3, k_w=3, d_h=1, d_w=1, stddev=0.02, name="g_conv2d_2_2"))
            h1_3 = tf.nn.relu(conv2d(h1_2, output_dim=128,
                       k_h=3, k_w=3, d_h=1, d_w=1, stddev=0.02, name="g_conv2d_2_3"))
            ...
            h2_1 = tf.nn.relu(conv2d(h2, output_dim=128,
                       k_h=3, k_w=3, d_h=1, d_w=1, stddev=0.02, name="g_conv2d_3_1"))
            h2_2 = tf.nn.relu(conv2d(h2_1, output_dim=128,
                       k_h=3, k_w=3, d_h=1, d_w=1, stddev=0.02, name="g_conv2d_3_2"))
            h2_3 = tf.nn.relu(conv2d(h2_2, output_dim=128,
                       k_h=3, k_w=3, d_h=1, d_w=1, stddev=0.02, name="g_conv2d_3_3"))
            ...
            h3_1 = tf.nn.relu(conv2d(h3, output_dim=128,
                       k_h=3, k_w=3, d_h=1, d_w=1, stddev=0.02, name="g_conv2d_4_1"))
            h3_2 = tf.nn.relu(conv2d(h3_1, output_dim=128,
                       k_h=3, k_w=3, d_h=1, d_w=1, stddev=0.02, name="g_conv2d_4_2"))
            h3_3 = tf.nn.relu(conv2d(h3_2, output_dim=128,
                       k_h=3, k_w=3, d_h=1, d_w=1, stddev=0.02, name="g_conv2d_4_3"))
